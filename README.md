...
5. **Role-Based Google Authentication**:
   ...
   - **ผู้ดูแลระบบ (Admin Whitelist)**: ยืนยันตัวตนด้วย **Google Account (Gmail: `suphalerk.chur@gmail.com`)** เพื่อสิทธิ์ในการบันทึกผลตรวจ, แก้ไขค่าน้ำหนัก, แนบภาพถ่าย, เพิ่มอุปกรณ์ใหม่ และสร้างรอบงวดใหม่
